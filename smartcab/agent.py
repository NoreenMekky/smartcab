...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1, alpha=0.2):
        ...
        ## TO DO ##
        ###########
        # Set any aditional class parameters as needed
        self.t = 0
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            if self.alpha>0 and self.alpha<1:
                self.epsilon = math.exp(-self.alpha*self.t*0.02)
                #self.epsilon = math.fabs(math.cos(self.alpha*self.t*3))
                self.t += 1
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            if random.random() <= self.epsilon:
                ...
                for act, Qval in self.Q[state].items():
                    if Qval == maxQval:
                        actls.append(act)
                action = random.choice(actls)
